...
create table if not exists public.compositions (
  ...
  category smallint check (category between 1 and 7),
...
alter table public.compositions add column if not exists category smallint check (category between 1 and 7);
