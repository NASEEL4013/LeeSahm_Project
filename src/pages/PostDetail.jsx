  ...
  return (
    <article className="post-detail">
      ...
      <div className="post-detail-grid"><div className="post-detail-image"><img src={image} alt={post.title} /></div><div className="post-detail-copy">
        ...
        {mine && !editing && <div className="owner-actions"><Link to={`/compose/${post.id}`}>그림 조합 수정</Link><button onClick={() => setEditing(true)}>설명 수정</button><button onClick={remove}>게시물 삭제</button></div>}
